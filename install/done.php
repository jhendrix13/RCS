...
//        $ch = curl_init('http://rcscript.net/add.php?url='. $_SESSION['path']);
...
<link rel="shortcut icon" href="img/favicon.ico" />
		...
		<div style="text-align: center; background: none;">
			...
			<div class="widescroll-content">
                            ...
                            <h2>Finished</h2>
                            You're finally finished with the installation of RCS. Hooray! If you wish to get traffic to your server & website, you can add your server to <a href="http://www.rscharts.com">RSCharts</a>.
                            <br/><br/>
